...
public class MyFavoriteBookListAdapter extends RecyclerView.Adapter<MyFavoriteBookListAdapter.ItemViewHolder> {

    private List<Book> mBookList;
    private Context mContext;

    public MyFavoriteBookListAdapter(List<Book> bookList) {
        mBookList = bookList;
    }
