...
public class NemoProfessionPickerFragment extends DialogFragment {
    ...
    private static final String ARG_PROFESSION = "com.rumofuture.nemo.view.fragment.NemoProfessionPickerFragment.profession";
    ...
    public static NemoProfessionPickerFragment newInstance(@NonNull String profession) {
        ...
        NemoProfessionPickerFragment fragment = new NemoProfessionPickerFragment();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_nemo_profession_picker, null);

        mListView = (ListView) view.findViewById(R.id.profession_list_view);
