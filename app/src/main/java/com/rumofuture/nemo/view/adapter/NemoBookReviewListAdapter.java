...
public class NemoBookReviewListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public NemoBookReviewListAdapter(NemoBookInfoFragment fragment, Book book, List<Review> reviewList) {
        mFragment = fragment;
        mBook = book;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        if (TYPE_BOOK == viewType) {
            ...
            final NemoBookReviewListAdapter.BookViewHolder holder = new NemoBookReviewListAdapter.BookViewHolder(view);
